...
def run():
    # Read the actual updated SVG files
  ...
  <style>
    * {{
    ...
    .header-center-logo svg {{
      height: 76px;
      width: auto;
      filter: drop-shadow(0 2px 10px rgba(186, 153, 122, 0.18));
    }}
    .header-actions {{
      display: flex;
      align-items: center;
...
<body>
  <div class="container">
    ...
    <div>
      ...
      <div class="mobile-wrapper" style="margin-top: 14px;">
        ...
        <div class="mobile-frame">
          <div class="mobile-header">
            <span style="font-size: 18px; cursor: pointer;">☰</span>
            <div class="logo-container" style="max-height: 48px; display: flex; align-items: center;">
              {horizontal_svg}
            </div>
            <span style="font-size: 18px; cursor: pointer;">🛍️</span>
          </div>
    ...
    print("HTML verification page generated!")
    cmd = [
        r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe",
        "--headless",
        "--disable-gpu",
        r'--screenshot=C:\Users\ahmed\kavelperfume\header_e2e_verification.png',
        "--window-size=1160,1520",
        r"file:///C:/Users/ahmed/kavelperfume/full_verification_page.html"
    ]
    subprocess.run(cmd, check=True)
    print("Edge screenshot completed!")
