...
export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="fixed bottom-20 sm:bottom-6 left-4 sm:left-6 z-40 px-3.5 sm:px-4 py-2.5 rounded-full bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold shadow-xl transition-all flex items-center gap-2 hover:scale-105 active:scale-95"
