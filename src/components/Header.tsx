          ...
          <div className="flex items-center justify-between h-24">
            ...
            <div className="flex items-center justify-end gap-3 flex-1">
              <button
                ...
                className="p-2 text-slate-700 hover:text-[#ba997a] transition-all rounded-xl hover:bg-slate-100 hidden sm:inline-flex cursor-pointer active:scale-95"
              ...
              <button
                ...
                className="relative p-2.5 rounded-xl bg-[#3f2911] text-white hover:bg-[#2a1a0a] transition-all flex items-center gap-2 shadow-xs cursor-pointer active:scale-95"
              ...
              <button
                ...
                className="md:hidden p-2 text-slate-700 hover:text-slate-900 rounded-xl hover:bg-slate-100 transition-all active:scale-95 cursor-pointer"
        ...
        <AnimatePresence>
          {mobileOpen && (
            <motion.div
              ...
              className="md:hidden bg-white border-b border-slate-200 px-4 pt-2 pb-6 space-y-3 shadow-xl overflow-hidden"
            >
              {navLinks.map((link, idx) => (
                <motion.a
                  ...
                  className="block px-4 py-3 rounded-xl text-sm font-bold text-slate-800 hover:bg-slate-50 hover:text-[#ba997a] transition active:scale-98"
                >
                  {link.label}
                </motion.a>
              ))}
              ...
              <div className="pt-3 border-t border-slate-100 flex flex-col gap-2">
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full py-2.5 bg-slate-100 text-slate-800 rounded-xl text-xs font-bold active:scale-98 transition"
                >
                ...
                <button
                  ...
                  className="flex items-center justify-center gap-2 w-full py-3 bg-[#3f2911] text-white rounded-xl text-xs font-bold active:scale-98 transition"
                >
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 w-full py-2.5 bg-emerald-50 text-emerald-700 rounded-xl text-xs font-bold border border-emerald-200 active:scale-98 transition"
                >
