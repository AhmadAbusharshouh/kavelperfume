...
export function LiveSearchModal({ isOpen, onClose }: LiveSearchModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-start justify-center p-4 sm:pt-20 overflow-y-auto" onClick={onClose}>
      <div
        className="bg-white border border-slate-200 rounded-3xl w-full max-w-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95"
      ...
      >
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className="p-2 bg-[#3f2911] hover:bg-[#2a1a0a] text-white rounded-xl text-xs transition"
        ...
        <div className="p-3 bg-slate-50 border-t border-slate-100 text-center">
          <Link
            href="/catalog"
            onClick={onClose}
            className="text-xs font-bold text-[#ba997a] hover:text-[#3f2911] transition inline-flex items-center gap-1"
          >
